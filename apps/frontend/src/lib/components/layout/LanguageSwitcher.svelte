...
<div
	class="relative flex items-center rounded-md border border-zinc-200 p-0.5 dark:border-zinc-700"
>
	<div
	...
	{#each locales as locale (locale)}
		<button
			...
			class="relative z-10 flex-1 rounded px-2 py-0.5 text-xs font-semibold transition-colors {currentLocale ===
			locale
