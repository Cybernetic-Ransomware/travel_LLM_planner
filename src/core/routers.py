...
from src.core import gmaps_router, optimizer_router, orchestrator_router, trips_router
...
router.include_router(trips_router, prefix="/core/trips", tags=["core", "trips"])
